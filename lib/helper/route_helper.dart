...
import 'package:efood_multivendor/view/screens/restaurant/subscriptions_screen.dart';
...
class RouteHelper {
  ...
  static const String traiteur = '/traiteur';
  ...
  static String getVerificationRoute(String number, String token, String page, String pass, String email) {
    return '$verification?page=$page&number=$number&token=$token&pass=$pass&email=$email';
  }
  ...
  static String getCategoryProductRoute(CategoryModel cat) {
    List<int> _encoded = utf8.encode(cat.name);
    String _data = base64Encode(_encoded);
    String _food = base64Encode(utf8.encode(cat.food));
    String _restaurants= base64Encode(utf8.encode(cat.restaurants));
    return '$categoryProduct?id=${cat.id}&name=$_data&food=$_food&restaurants=$_restaurants';
  }
  ...
  static String getSubscriptionsRoute(int restaurantID) => '$subscriptions?id=$restaurantID';
  ...
  static String getTraiteurRoute() => '$traiteur';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: verification, page: () {
         List<int> _decode=[];
         print("----par ${Get.parameters}");
     if(Get.parameters['pass'].length>0 && Get.parameters['pass'].contains("+")){
   _decode = base64Decode(Get.parameters['pass'].replaceAll(' ', '+'));
     }
    ...
    GetPage(name: subscriptions, page: () {
      return getRoute(Get.arguments != null ? Get.arguments : SubscriptionsScreen(restaurant: Restaurant(id: int.parse(Get.parameters['id']))));
    }),
    ...
    GetPage(name: categoryProduct, page: () {
      ...
      String _data = utf8.decode(_decode);
      String _food = utf8.decode(base64Decode(Get.parameters['food'].replaceAll(' ', '+')));
      String _restaurants = utf8.decode(base64Decode(Get.parameters['restaurants'].replaceAll(' ', '+')));
      return getRoute(CategoryProductScreen(categoryID: Get.parameters['id'], categoryName: _data, foodLabel: _food, restaurantsLabel: _restaurants,));
    }),
    ...
    GetPage(name: traiteur, page: () => getRoute(MapViewScreen())),
