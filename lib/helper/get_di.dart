...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => TraiteurRepo(apiClient: Get.find()));
  ...
  Get.lazyPut(() => LocationController(locationRepo: Get.find(), sharedPreferences: Get.find()));
  Get.lazyPut(() => UserController(userRepo: Get.find()));
  Get.lazyPut(() => TraiteurController(traiteurRepo: Get.find()));
  Get.lazyPut(() => BannerController(bannerRepo: Get.find()));
  Get.lazyPut(() => CategoryController(categoryRepo: Get.find()));
  Get.lazyPut(() => ProductController(productRepo: Get.find()));
  Get.lazyPut(() => CartController(cartRepo: Get.find()));
  Get.lazyPut(() => InfosController(Duration(minutes: 15)));
