...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    if(_isLoggedIn) {
      ...
      if(Get.find<SplashController>().configModel.versementBancaire!=null && 
      Get.find<SplashController>().configModel.versementBancaire.length>0)
      {
     
        _isbankTransferActive=Get.find<SplashController>().configModel.IsversementBancaireActive;
            if(_isbankTransferActive){
            _bankTransfer=Get.find<SplashController>().configModel.versementBancaire;
            }
        ...
        return GetBuilder<RestaurantController>(builder: (restController) {
          ...
          return GetBuilder<CouponController>(builder: (couponController) {
            return GetBuilder<OrderController>(builder: (orderController) {
              ...
              double _weather = Get.find<LocationController>().hasPrecipitation ? (Get.find<SplashController>().configModel?.weatherCommission ?? 0) : 0;
              ...
              double _total = _subTotal + _deliveryCharge - _discount - _couponDiscount + _tax + orderController.tips + _weather;
                  ...
                  Expanded(child: Scrollbar(child: SingleChildScrollView(
                    ...
                    child: Center(child: SizedBox(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Center(child:        GetBuilder<LocationController>(builder:(controller) => controller.hasPrecipitation ? Container(
                ...
                mainAxisSize: MainAxisSize.max,
                  children: [
                    SizedBox(
                      height: 64,
                      width: 64,
                      child: Image.asset(controller.wheaterIcon),
                    ),
                    Expanded(child :Text("due_to_bad_weather_you_will_have_to_pay_an_extra_fee_to_the_deliveryman".tr, maxLines: 3,))
                  ]
                ),) : SizedBox.shrink(),),),
                        Container(
                          width: context.width,
                             ...
                             Text('choose_payment_method'.tr, style: robotoMedium),
                              ...
                              SingleChildScrollView(scrollDirection: Axis.horizontal,
                               ...
                               // width: MediaQuery.of(context).size.width,
                                ...
                                _isbankTransferActive==null?Container():
                                   _isbankTransferActive ? PaymentButton(
                                    icon: Images.wallet,
                                    title: 'bank_transfer'.tr,
                                    subtitle: 'pay_using_bank_transfer'.tr,
                                    index: 3,
                                  ) : SizedBox(),
 ...
 Container(
  width: MediaQuery.of(context).size.width,
   ...
   child: InkWell(
      onTap: ()async{
      await Clipboard.setData(ClipboardData(text: Get.find<SplashController>().configModel.versementBancaire));
     ...
     child: Row(children: [
      ...
      RichText(
        ...
        TextSpan(
       text:Get.find<SplashController>().configModel.bankName,
      ...
      RichText(
        ...
        TextSpan(
       text:Get.find<SplashController>().configModel.owner,
      ...
      RichText(
       ...
       TextSpan(
       text:Get.find<SplashController>().configModel.versementBancaire,              
       style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge,
       color: Theme.of(context).primaryColor )
       ),
       ]
      ...
      RichText(
        ...
        TextSpan(
       text:Get.find<SplashController>().configModel.bic,
        ...
        Container(
          ...
          TextSpan(
               text:Get.find<SplashController>().configModel.note,
     ...
     Icon(Icons.copy)
                        ...
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            GetBuilder<LocationController>(builder:(controller) => controller.hasPrecipitation ? Container(
                            
                            margin: EdgeInsets.only(top:Dimensions.PADDING_SIZE_SMALL),
                            child:  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('weather'.tr, style: robotoRegular),
                            Text('(+) ${PriceConverter.convertPrice(_weather)}', style: robotoRegular),
                          ]),) : SizedBox.shrink(),),
                            Padding(
                    ...
                    child: !orderController.isLoading ? CustomButton(buttonText: 'confirm_order'.tr, onPressed: () {
                      ...
                      if(!_isCashOnDeliveryActive && !_isDigitalPaymentActive && !_isWalletActive) {
                        ...
                        orderController.placeOrder(PlaceOrderBody(
                          ...
                          paymentMethod:orderController.paymentMethodIndex == 3?"bank_transfer": orderController.paymentMethodIndex == 0 ? 'cash_on_delivery'
  ...
  void _callback(bool isSuccess, String message, String orderID, double amount) async {
    if(isSuccess) {
      ...
      Get.find<OrderController>().stopLoader();
      if(Get.find<OrderController>().paymentMethodIndex == 3 || Get.find<OrderController>().paymentMethodIndex == 0 || Get.find<OrderController>().paymentMethodIndex == 2) {
