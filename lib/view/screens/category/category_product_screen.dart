...
class CategoryProductScreen extends StatefulWidget {
  ...
  CategoryProductScreen(
      {@required this.categoryID, @required this.categoryName, @required this.foodLabel, @required this.restaurantsLabel});
...
class _CategoryProductScreenState extends State<CategoryProductScreen>
  ...
  void initState() {
    ...
    print("CategoryProduct ${{
      ...
      "foodLabel" : widget.foodLabel,
      "restaurantsLabel" : widget.restaurantsLabel,
    }}");
                ...
                child: Column(children: [
                  ...
                  Center(
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        Tab(text: (widget.foodLabel ?? "food").toLowerCase() != "food" ? widget.foodLabel : 'food'.tr),
                        Tab(text: (widget.restaurantsLabel ?? "restaurants").toLowerCase() != "restaurants" ? widget.restaurantsLabel : 'restaurants'.tr),
                      ],
                    ),
                  )),
                  VegFilterWidget(
