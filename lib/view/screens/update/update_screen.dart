...
class UpdateScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFFAC6904),
      body: Center(
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Image.asset(
              ...
              width: MediaQuery.of(context).size.height*0.4 * 1.5,
              height: MediaQuery.of(context).size.height*0.4* 1.5,
            ),
            SizedBox(height: MediaQuery.of(context).size.height*0.01),

            Text(
              isUpdate ? 'update'.tr : 'we_are_under_maintenance'.tr,
              style: robotoBold.copyWith(fontSize: MediaQuery.of(context).size.height*0.023 * 2, color: Theme.of(context).primaryColor),
            ...
            Text(
              ...
              style: robotoRegular.copyWith(fontSize: MediaQuery.of(context).size.height*0.0175 * 2, color: Theme.of(context).disabledColor),
              textAlign: TextAlign.center,
            ),
