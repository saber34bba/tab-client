    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(builder: (userController) {
        if(userController.userInfoModel != null && _phoneController.text.isEmpty) {
          ...
          _birthdayController.text=userController.userInfoModel.birthday??'';
        }
    ...
    if (userController.userInfoModel.fName == _firstName &&
       ...
       if(_birthdayController.text.isNotEmpty){
        UserInfoModel _updatedUser = UserInfoModel(
          fName: _firstName, lName: _lastName, email: _email, phone: _phoneNumber,birthday: _birthdayController.text);
