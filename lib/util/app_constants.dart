...
class AppConstants {
  static const String APP_NAME = 'TAB (The-AfricanBasket)';
  ...
  static const String TRAITEUR_URI = '/api/v1/traiteur?NDD9ZVAFOUVJT75709S4ZPM6';
  ...
  static const String WEATHER_URI = '/api/v1/config/weather-api';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.french, languageName: 'Francais', countryCode: 'FR', languageCode: 'fr'),
