...
class NotificationHelper extends NotificationBase {
  ...
  Future<void> initialize() async {
    print("LOAD_PUSH_NOTIFICATION");
    var androidInitialize = new AndroidInitializationSettings('notification_icon');
    var iOSInitialize = new DarwinInitializationSettings();
    // var iOSInitialize = new IOSInitializationSettings();
    var initializationsSettings = new InitializationSettings(android: androidInitialize, iOS: iOSInitialize);
    fln.initialize(initializationsSettings, onDidReceiveNotificationResponse: (NotificationResponse notificationResponse) async {
      try{
        NotificationBody _payload;
        if(notificationResponse.payload != null && notificationResponse.payload.isNotEmpty) {
          _payload = NotificationBody.fromJson(jsonDecode(notificationResponse.payload));
    ...
    // fln.initialize(initializationsSettings, onSelectNotification: (String payload) async {
    //   try{
    //     NotificationBody _payload;
