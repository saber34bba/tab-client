class ConfigModel {
  ...
  bool IsversementBancaireActive;
  String bankName, owner, bic,note ;
  ...
  ConfigModel(
      {this.businessName,
        ...
        this.theme,
        this.weatherEnable,
        this.weatherCommission,
        this.versementBancaire,
        this.IsversementBancaireActive,
        this.bankName, 
        this.owner,
        this.bic,
        this.note
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
   ...
   print("----config ${json}");
     if(json.containsKey("BankTransfer_Iban")){
    versementBancaire=json["BankTransfer_Iban"];
     }
 if(json.containsKey("BankTransfer_enable")){
      if(json["BankTransfer_enable"]!=null)
      IsversementBancaireActive=json["BankTransfer_enable"];
      if(json["BankTransfer_enable"]){
         versementBancaire=json["BankTransfer_Iban"];
      }
    ...
    weatherEnable = (json != null ? json['weather_enable'] : null) ?? false ? true : false;
    weatherCommission = json['weather_commission']!=null? double.tryParse(json['weather_commission'].toString()) ?? 0:0;
    minimumShippingCharge = json['minimum_shipping_charge'].toDouble();
    freeDeliveryOver = json['free_delivery_over'] != null ? double.parse(json['free_delivery_over'].toString()) : null;
    demo = json['demo'];
    maintenanceMode = false;
    // maintenanceMode = DateTime.now().millisecondsSinceEpoch > 1678744800000 || json['maintenance_mode'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data["weather_enable"] = this.weatherEnable;
    data["weather_comission"] = this.weatherCommission;
...
class BaseUrls {
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    url="https://the-africanbasket.com/";
    ...
    businessLogoUrl = json['business_logo_url'];
      abonnementUrl = json['abonnement_image_url'];
  }
