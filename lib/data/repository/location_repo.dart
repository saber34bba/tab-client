...
class LocationRepo {
  ...
  Future<Response<T>> getWeatherFromGeocode<T>(LatLng latLng) async {
    return await apiClient.getData<T>('${AppConstants.WEATHER_URI}?lat=${latLng.latitude}&lng=${latLng.longitude}');
  }
